        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="btn-whatsapp flex items-center gap-2.5 px-8 py-5 rounded-lg text-base font-semibold uppercase tracking-widest w-full sm:w-auto justify-center"
            >
