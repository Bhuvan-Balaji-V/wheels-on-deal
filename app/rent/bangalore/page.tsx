        ...
        <div className="container-luxury">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a
              ...
              className="btn-whatsapp inline-flex items-center gap-2 px-8 py-5 rounded-xl text-base font-semibold uppercase tracking-widest w-full sm:w-auto justify-center"
            >
