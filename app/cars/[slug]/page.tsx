            ...
            <div className="sticky top-28 space-y-4">
              ...
              >
                ...
                <a
                  ...
                  className="btn-whatsapp w-full py-5 rounded-xl text-base font-semibold uppercase tracking-widest text-center flex items-center justify-center gap-2 mb-3"
                >
