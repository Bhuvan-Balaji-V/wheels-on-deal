      ...
      <div className="pt-32 pb-16 relative overflow-hidden" style={{ background: "#0A0A0A" }}>
        ...
        <div className="container-luxury max-w-3xl text-center mx-auto">
          ...
          <a
            ...
            className="btn-whatsapp inline-flex items-center gap-2 px-6 py-4 rounded-lg text-base font-semibold uppercase tracking-widest"
          >
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="btn-whatsapp inline-flex items-center gap-2 px-6 py-4 rounded-lg text-base font-semibold uppercase tracking-widest justify-center"
              >
                WhatsApp Us
              </a>
              <Link
